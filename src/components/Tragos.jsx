...
import { tragos } from "../module";

const Tragos = () => {
  return (
    <section
      id="tragos"
      className="py-20 bg-gradient-to-br from-green-50 to-red-500 px-5 md:px-28"
    >
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            "Para que exista el arte, para que exista cualquier tipo de actividad
            o percepción estetica, es indispensable una determinada condición fisiológica:
            la intoxicación". - Friedrich Nietzsche.
          </p>
        </div>
