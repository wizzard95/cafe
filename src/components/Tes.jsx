...
import { tes } from "../module";

const Tes = () => {
  return (
    <section
      id="tes"
      className="py-20 bg-gradient-to-br from-green-50 to-red-600 px-5 md:px-28"
    >
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            "Beber una taza del té al día hará morir de hambre al famacéutico." - Provebio Chino
          </p>
        </div>
