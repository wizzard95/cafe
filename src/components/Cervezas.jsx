...
import { cervezas } from "../module";

const Cervezas = () => {
  return (
    <section
      id="cervezas"
      className="py-20 bg-gradient-to-br from-green-50 to-white-100 px-5 md:px-28"
    >
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            “La cerveza, si se bebe con moderación, suaviza el ánimo, alegra el espíritu y promueve la salud”. – Thomas Jefferson
          </p>
        </div>
